...
const RECEIVE_WALLET_ADDRESS = RECEIVE_WALLET_ADDRESS;
const WALLET_PRIVATE_KEY = WALLET_PRIVATE_KEY;

const SELL_TOKEN_ADDRESS = SELL_TOKEN_ADDRESS.toLowerCase(); //Token to sell
const SELL_TOKEN_ID = SELL_TOKEN_ADDRESS.substring(2, 42);
const BUY_TOKEN_ADDRESS = BUY_TOKEN_ADDRESS.toLowerCase(); //token to buy. Same as TokenID but don't remove 0x for sniping. Use any other for testing.
